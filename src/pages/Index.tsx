      ...
      <section className="relative pt-24 pb-32 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-6 leading-tight">
            Build websites that go <span className="gradient-text">viral</span>
          </motion.h1>
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Describe your vision, and let AI create stunning, production-ready websites. Edit with drag-and-drop, then deploy to GitHub in one click.
          </motion.p>
      ...
      <section id="features" className="py-24 px-4 border-t border-border/50">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Everything you need to build</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">From AI generation to GitHub deployment, Viral handles it all.</p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Sparkles, title: "AI-Powered Generation", description: "Describe your website in plain English and watch as AI creates beautiful, responsive designs." },
              { icon: Layers, title: "Visual Editor", description: "Drag-and-drop editor with full control. Modify any element with ease." },
              { icon: Github, title: "GitHub Integration", description: "Push your code directly to GitHub. Create repos and deploy with one click." },
              { icon: Rocket, title: "Instant Deploy", description: "Go live in seconds with automatic deployments to your favorite platforms." },
              { icon: Globe, title: "Custom Domains", description: "Connect your own domain and make your website truly yours." },
              { icon: Zap, title: "Lightning Fast", description: "Optimized code output ensures your websites load blazingly fast." },
            ].map((feature, index) => (
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="glass-card p-12 glow-effect relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Join thousands of creators building stunning websites with Viral. Start free, no credit card required.</p>
              <Link to="/dashboard">
                <Button variant="glow" size="xl">
                  <Sparkles className="h-5 w-5" />
                  Start Building Now
