    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative pt-24 pb-32 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Describe your vision, and let AI create stunning, production-ready
            websites. Edit with drag-and-drop, then deploy to GitHub in one click.
          </motion.p>
        ...
        >
          <div className="relative">
            ...
            <div className="glass-card p-2 glow-effect">
              <img 
                src={heroPreview} 
                alt="Viral Website Builder Interface" 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              From AI generation to GitHub deployment, Viral handles it all.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Describe your website in plain English and watch as AI creates beautiful, responsive designs.",
              },
              {
                icon: Layers,
                title: "Visual Editor",
                description:
                  "Drag-and-drop editor with full control. Modify any element with ease.",
              },
              {
                icon: Github,
                title: "GitHub Integration",
                description:
                  "Push your code directly to GitHub. Create repos and deploy with one click.",
              },
              {
                icon: Rocket,
                title: "Instant Deploy",
                description:
                  "Go live in seconds with automatic deployments to your favorite platforms.",
              },
              {
                icon: Globe,
                title: "Custom Domains",
                description:
                  "Connect your own domain and make your website truly yours.",
              },
              {
                icon: Zap,
                title: "Lightning Fast",
                description:
                  "Optimized code output ensures your websites load blazingly fast.",
              },
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
            className="glass-card p-12 glow-effect relative overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
                Join thousands of creators building stunning websites with Viral.
